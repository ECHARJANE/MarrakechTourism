...
<head>
    ...
    <link href="{{ asset('assets/css/icons/fontawesome.min.css') }}" rel="stylesheet" media="screen">       
    {{-- <link href="{{ asset('assets/css/icons/all.min.css') }}" rel="stylesheet" media="screen">        --}}
                ...
                <div class="row">
                    <div class="col-md-6">
                        <ul class="visible-md visible-lg text-left">
                            <li><a href="tel:+212 649-31-47-70"><i class="fa fa-phone"></i> +212 649-31-47-70</a></li>
                            <li><a href="mailto:mustaphaecharjane@gmail.com"><i class="fa fa-envelope"></i>
                                    mustaphaecharjane@gmail.com</a></li>
                        </ul>
                        <ul class="visible-xs visible-sm">
                            <li class="text-left"><a href="tel:+212 649-31-47-70"><i class="fa fa-phone"></i>
                                    +212 649-31-47-70</a></li>
                            <li class="text-right"><a href="index.php/changelocation.html"><i
                                        class="fa fa-map-marker"></i>Dawdiyat Av Alal Alfassi Marrakech</a></li>
                        </ul>
                    </div>
                    <div class="col-md-6">
                        <ul class="visible-md visible-lg text-right">
                            <li><i class="fa fa-whatsapp" aria-hidden="true"></i> +212 649-31-47-70</li>
                            <li><a href="index.php/changelocation.html"><i class="fa fa-map-marker"></i> Dawdiyat Av Alal Alfassi Marrakech</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <header id="header" class="header-v3">
            <nav class="flat-mega-menu">
                ...
                <ul class="collapse">
                    ...
                    <li> <a href="/">Home</a> </li>
                    <li> <a href="{{ route('services.index') }}">Special Services</a></li>
                    ...
                    @endif
                    <li class="login-form"><a href="{{ route('logout') }}" onclick="event.preventDefault();document.getElementById('frmLogout').submit();">Logout</a>
                      <form action="{{ route('logout') }}" method="POST" id="frmLogout">
                        @csrf
                      </form>
                    </li>
                    <li class="login-form"><span>{{ Auth::user()->name }}</span></li>
