  ...
  <nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
      ...
      <!-- Brand -->
      <a class="navbar-brand pt-0 mt-12" href="dashboard.php">
      ...
      <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{ route('admin.commentair') }}">
              <i class="fa-solid fa-comment-dots text-primary"></i> Commentaire
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="products.php">
              <i class="fa-solid fa-cart-plus text-primary"></i>Products
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="orders.php">
              <i class="fa-solid fa-bag-shopping text-primary"></i> Orders
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="payments.php">
              <i class="fa-solid fa-credit-card text-primary"></i> Payments
            </a>
          </li>
          <li class="nav-item">
