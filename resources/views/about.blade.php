...
@section('content')
        ...
        <section class="content-central">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div id="single-carousel">
                                    <div class="img-hover">
                                        <div class="overlay"> <a href="{{ asset('assets/myimage/slaider55.jpg') }}" class="fancybox"><i
                                                    class="fa fa-plus-circle"></i></a></div>
                                        <img src="{{ asset('assets/myimage/slaider55.jpg') }}" alt="" class="img-responsive">
                                    </div>
                                    <div class="img-hover">
                                        <div class="overlay"> <a href="{{ asset('assets/myimage/slaider55.jpg') }}" class="fancybox"><i
                                                    class="fa fa-plus-circle"></i></a></div>
            ...
            <div class="content_info overflow-hidde">
                <video class="bg_video" preload="auto" autoplay="autoplay" loop="" muted="" poster="{{ asset('img/slide/4.jpg') }}"
                    data-setup="{}">
